...
public class PaperButton extends View {
    ...
    public PaperButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColor = attributes.getColor(R.styleable.PaperButton_paper_color, getResources().getColor(R.color.paper_button_color));
        ...
        mRippleColor = attributes.getColor(R.styleable.PaperButton_paper_ripple_color,
                getResources().getColor(R.color.paper_ripple_color));
...
//        ripplePaint.setColor(darkenColor(mColor));
        ripplePaint.setColor(/*darkenColor*/(mRippleColor));
...
//                ripplePaint.setAlpha(255);
                ripplePaint.setAlpha(Color.alpha(mRippleColor));
...
//                    int alpha = Math.round((ANIMATION_DURATION - elapsed) * 255 / ANIMATION_DURATION);
                    int alpha = Math.round((ANIMATION_DURATION - elapsed) * Color.alpha(mRippleColor) / ANIMATION_DURATION);
...
//                    ripplePaint.setAlpha(0);
    ...
    public void enableColorText(boolean isColored) {
        if (isColored)
            this.setTextColor(mTextColor);
        else
            this.setTextColor(getResources().getColor(R.color.paper_ripple_color));
    }
