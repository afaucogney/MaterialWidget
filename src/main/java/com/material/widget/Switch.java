...
//    private final int mCheckedColor;
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.Switch);
...
//        mThumbCheckedColor = getResources().getColor(R.color.switch_thumb_checked_color);
        mThumbCheckedColor = attributes.getColor(R.styleable.Switch_switch_checked_color,
                getResources().getColor(R.color.switch_track_checked_color));
